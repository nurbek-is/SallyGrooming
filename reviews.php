...
<main id='mainservices'>
    <section class='services'>
        <section  class='subservices'>
            ...
            <section class='subservices'>
                <h3><span></span></h3>
                <img src="images/pug-246x300.jpeg" alt="pug">
                <p>Sandy's Grooming  is a GREAT company. The entire team is always so flexible and wonderful! We are definitely sad to be moving away from them! It was great knowing that our dog was in good hands while we were at work all day. They would frequently send us pictures and updates on what was going on, and we could feel a genuine love and interest in our Pet!”        –Emily W, client since 2014 </p>
            </section>
            
            <section class='subservices'>
                <h3><span></span></h3>
                <img src="images/long-nose-dog-aprx-246x300.jpeg" alt="long nose dog">
