...
<main id='main-canvas-purpleBg'>
    ...
    <section class='services'>
        ...
        <section class='clear-subsection'>
                ...
                <div class='index-text'><h4>Premium Wash</h4>
                <p class='white-text-color'>Includes your choice of premium shampoos, cream rinse, leave-in coat shiner & skin moisturizer, cologne, apron, brushes & combs, towels & dryer.Premium Wash </p>
                <button class='book-btn'><a href="grooming.php">Schedule Now</a></button>
                <ul id="category-tabs">
                    <li><a href="javascript:void"><i class="fa fa-plus-circle"></i>Click to View Grooming Rates and Details</a>
                        <ul class='rates-ul'>
                ...
                <h4>Ultimate Wash</h4>
                <div class='service-para-wrapper'><p class='white-text-color'>Includes shampoo, conditioner, leave-in coat shiner & skin moisturizer, cologne, apron, brushes & combs, towels & dryer.quam architecto tenetur. Similique quo quos dignissimos!locale_get_region</p></div>
                <button class='book-btn'><a href="grooming.php">Schedule Now</a></button>
                <ul id="category-tabs">
                    <li><a href="javascript:void"><i class="fa fa-plus-circle"></i>Click to View Grooming Rates and Details</a>
                        <ul class='rates-ul'>
