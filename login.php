<?php
  ...
  //  Setting $username and $passPhrase
    ...
    try {
      ...
      if (!$row = $stmt->fetch()) {
       ...
       $_SESSION['user-id'] = $row['user_id'];
        // if user clicked remember-me checkbox,create a 'token' cookie for 30days(in min)
       ...
       // Could not insert cookie token, Fail silently If the insert fails due to a PDOException,
